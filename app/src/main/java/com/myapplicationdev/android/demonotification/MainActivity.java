...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnNofity1,btnNofity2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        btnNofity1 = (Button)findViewById(R.id.btnNotify1);
        btnNofity2 = (Button)findViewById(R.id.btnNotify2);

        btnNofity1.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            btnNofity2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(MainActivity.this,MainActivity.class);
